// Dashboard Module - Business Dashboard (no profile content)
...
// Farmer Profile Page
async function loadFarmerProfilePage(container, user) {
    // Fetch farmer's data
...
// Veterinarian Profile Page
async function loadVetProfilePage(container, user) {
...
async function loadAgrovetsProfilePage(container, user) {
...
async function loadProfilePage() {
    ...
    try {
        if (user.role === 'farmer') {
            await loadFarmerProfilePage(profileContent, user);
        } else if (user.role === 'vet') {
            await loadVetProfilePage(profileContent, user);
        } else if (user.role === 'agrovets') {
            await loadAgrovetsProfilePage(profileContent, user);
        }
    } catch (error) {
